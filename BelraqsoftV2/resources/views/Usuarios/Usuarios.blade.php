        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="FormularioRegistro{{ $modulo }}Label">Registro de {{ $modulo }}
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form class="text-center fst-italic needs-vblaalidation row formulario"
                        action="{{ route('usuarioRegistrar') }}" method="POST">
                        @csrf
                        <!-- NIVEL 1 -->
                        <div class="col-lg-12">
                            {{-- Nombre Usuario --}}
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="Text" class="form-control" placeholder="Documento del usuario"
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Correo del usuario"
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" placeholder="Teléfono(s) del usuario"
                                    name="Telefonos" id="Telefonos" value="{{ old('Teléfonos') }}">
                            </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input class="IngresoDatos form-control" type="text" name="Ciudad_Municipio"
                                    placeholder="Ciudad/municipio del usuario" id="Ciudad_Municipio"
            ...
            @forelse ($usuarios as $usuario)
                <tr>
                    ...
                    <td>
                        <form action="{{ route('usuarioEliminar', $usuario) }}" method="post"
                            ...
                            <button class="btn btn-danger boton-listado" data-bs-toggle="modal"
                                data-bs-target="#EliminarUsuario" type="button"><i
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            <div class="swal2-html-container" id="swal2-html-container"
                                                style="display: block;">¡El usuario {{ $usuario->Nombres }}
                                                {{ $usuario->Apellidos }}
                    ...
                    <td>
                        <form class="form-check form-switch form-switch-md formulario"
                            action="{{ route('usuarioEstado', $usuario) }}" method="post">
                            @csrf
                            @if ($usuario->Estado == 1)
                ...
                <div class="modal fade" id="EdicionUsuarios{{ $usuario->id }}" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="EdicionUsuariosLabel{{ $modulo }}Label">Edición de
                                    usuario</h5>
                            ...
                            <div class="modal-body">
                                <form class="text-center fst-italic needs-validation row formulario"
                                    action="{{ route('usuarioActualizar', $usuario) }}" method="POST">
                                    @csrf @method('PUT')
                                    <!-- NIVEL 1 -->
                                    <div class="col-lg-12">
                                        {{-- Nombre Usuario --}}
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Apellidos del usuario" name="Apellidos" id="Apellidos"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="form-select IngresoDatos form-control"
                                                ...
                                                <option selected="true" value="{{ $usuario->TipoDocumento }}">
                                                    {{ $usuario->unionTipoDoc->Abreviatura }}</option>
                                                @foreach ($TipoDocumentos as $tipo)
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="date" class="form-control" placeholder="Fecha de expedición"
                                                ...
                                                value="{{ old('FechaExpedicion', $usuario->FechaExpedicion) }}">
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1"><i
                                                    class="bi bi-caret-right-fill"></i></span>
                                            <select class="form-select IngresoDatos form-control"
                                                aria-label="Default select example" name="Rol" id="Rol"
                                                value="{{ old('Rol') }}">
                                                <option selected="true" value="{{ $usuario->Rol }}">
                                                    {{ $usuario->unionRol->Nombre }}</option>
                                                @foreach ($Roles as $Rol)
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" class="form-control"
                                                placeholder="Teléfono(s) del usuario" name="Telefonos" id="Telefonos"
                                                value="{{ old('Teléfonos', $usuario->Telefonos) }}">
                                        </div>
                                        <small class="text-danger">{{ $errors->first('Teléfonos') }}</small>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control"
                                                placeholder="Dirección del usuario" name="Direccion" id="Direccion"
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="IngresoDatos form-control" type="text"
                                                name="Ciudad_Municipio" placeholder="Ciudad o municipio del usuario"
                                                id="Ciudad_Municipio"
                                                value="{{ old('Ciudad_Municipio', $usuario->Ciudad_Municipio) }}">
                                        </div>
                                        <small class="text-danger">{{ $errors->first('Ciudad_Municipio') }}</small>
                                    </div>
